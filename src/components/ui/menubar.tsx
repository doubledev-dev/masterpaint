...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn("flex items-center bg-secondary-100", className)}
    {...props}
  />
));
